<!DOCTYPE html>
<!--Connect to database server with permission of guest or user-->
<?php
session_start();
...
try {
  ...
  echo "Connected successfully to database for $username";
...
<nav> <!--Should make them into a list-->
    ...
    <?php
    if (!isset($_SESSION['user'])){//if the user hasn't login 
        echo '<a class="btn" href="login.html">Login</a>';
        echo '<a class="btn" href="register.html">Register</a>';
    }else{// has login
        echo'<a class="btn" href="profile.html">Profile</a>';
